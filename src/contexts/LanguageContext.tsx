...
const translations = {
  ...
  ta: {
    // Login page translations in Tamil
    ...
    remainingStock: 'மீதமுள்ள சரக்கு',
    unit: 'அலகு',
    price: 'விலை',
    brand: 'பிராண்ட்',
    ...
    failedToLoadDashboard: 'முகப்பு தரவை ஏற்ற முடியவில்லை',
    ...
    manageProductInventory: 'உங்கள் பொருள் சரக்கு மற்றும் இருப்பு நிலைகளை நிர்வகிக்கவும்',
    productList: 'பொருள் பட்டியல்',
    productsFound: 'பொருட்கள் கண்டறியப்பட்டன',
    ...
    unitPlaceholder: 'கிலோ, துண்டுகள், போன்றவை',
